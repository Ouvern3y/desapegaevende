...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (stickyBar && heroSection) {
    const handleScroll = () => {
      ...
      const isOfferVisible = offerRect && (offerRect.top < window.innerHeight - 80 && offerRect.bottom > 80);

      // Mostra a barra quando o final do Hero estiver saindo do topo e a oferta não estiver em foco
      if (heroRect.bottom < 80 && !isOfferVisible) {
